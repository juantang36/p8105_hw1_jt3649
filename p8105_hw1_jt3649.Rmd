...
The as.numeric function converts logical variables to numeric numbers. "as.numeric(pull(df, "vec_positive"))" defines TRUE = 1 and FALSE = 0. The mean therefore represents the proportion of TRUE values. 
